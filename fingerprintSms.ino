...
const char *ssid = "Cockpit";
const char *password = "print2020";
const char *device_token = "f8cd4a03";
//************************************************************************
String getData, Link;
String SN;
String URL = "http://192.168.0.110/biometricattendance/getdata.php"; // computer IP or the server domain
//************************************************************************
...
void SendFingerprintID(int finger)
{
    ...
    if (WiFi.isConnected())
    {
        ...
        if (payload.substring(10, 15) == "login")
        {
            String user_name = payload.substring(15);
			String SN = payload.substring(0,10);
            ...
            display.display();
            // Sending ENTRY sms
            Serial.println("sending entry sms....");
            delay(50);
            sim800L.println("AT+CMGF=1");
            delay(1000);
            sim800L.println("AT+CMGS=\"+880"+ SN +"\"");
            delay(1000);
            sim800L.println("THE USER " + user_name + " HAS ENTERED IN THE OFFICE");
            delay(100);
            sim800L.write(0x1A);
            delay(1000);
        }
        else if (payload.substring(10, 16) == "logout")
        {
            String user_name = payload.substring(16);
			      String SN = payload.substring(0,10); //getting phone number from database
            //  Serial.println(user_name);
            ...
            sim800L.println("AT+CMGS=\"+880"+ SN +"\"");
            delay(1000);
            sim800L.println("THE USER " + user_name + " EXITED FROM  THE OFFICE");
            delay(100);
            sim800L.write(0x1A);
            delay(1000);
        }
